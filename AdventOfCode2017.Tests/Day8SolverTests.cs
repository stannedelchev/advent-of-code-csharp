...
namespace AdventOfCode2017.Tests
{
    ...
    public class Day8SolverTests
    {
        ...
        public void Part2_Passes()
        {
            ...
            Assert.AreEqual(5471, result);
        }

        [TestInitialize]
        public void Initialize()
        {
            this.solver = new Day8.Solver();
        }

        #region Inputs

        private string exampleInput = @"b inc 5 if a > 1
a inc 1 if b < 5
c dec -10 if a >= 1
c inc -20 if c == 10";

        private string realInput = @"gug dec 188 if zpw >= 8
