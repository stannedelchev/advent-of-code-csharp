...
namespace AdventOfCode2017.Tests
{
    ...
    public class Day4SolverTests
    {
        ...
        {
            Assert.AreEqual(1, this.solver.SolvePart1("aa bb cc dd ee "));
        }

        [TestMethod]
        public void Part1Example2_Passes()
        {
            Assert.AreEqual(0, this.solver.SolvePart1("aa bb cc dd aa"));
        }

        [TestMethod]
        public void Part1Example3_Passes()
        {
            Assert.AreEqual(1, this.solver.SolvePart1("aa bb cc dd aaa"));
        }

        [TestMethod]
        public void Part1_Passes()
        {
            Assert.AreEqual(477, this.solver.SolvePart1(this.part1Input));
        }

        [TestMethod]
        public void Part2Example1_Passes()
        {
            Assert.AreEqual(1, this.solver.SolvePart2("abcde fghij"));
        }

        [TestMethod]
        public void Part2Example2_Passes()
        {
            Assert.AreEqual(0, this.solver.SolvePart2("abcde xyz ecdab"));
        }

        [TestMethod]
        public void Part2Example3_Passes()
        {
            Assert.AreEqual(1, this.solver.SolvePart2("a ab abc abd abf abj"));
        }

        [TestMethod]
        public void Part2Example4_Passes()
        {
            Assert.AreEqual(1, this.solver.SolvePart2("iiii oiii ooii oooi oooo"));
        }

        [TestMethod]
        public void Part2Example5_Passes()
        {
            Assert.AreEqual(0, this.solver.SolvePart2("oiii ioii iioi iiio"));
        }

        [TestMethod]
        public void Part2_Passes()
        {
            Assert.AreEqual(167, this.solver.SolvePart2(this.part1Input));
        }

        [TestInitialize]
        public void Initialize()
        {
            this.solver = new Day4.Solver();
        }



        #region Part 1 Input
        private string part1Input = @"una bokpr ftz ryw nau yknf fguaczl anu
