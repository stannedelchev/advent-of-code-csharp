...
namespace AdventOfCode2017.Tests
{
    ...
    public class Day7SolverTests
    {
        ...
        {
            var result = this.solver.SolvePart1(this.exampleInput);
        ...
        {
            var result = this.solver.SolvePart2(this.exampleInput);
        ...
        {
            var result = this.solver.SolvePart1(this.realInput);
            Assert.AreEqual("mkxke", result);
        }

        [TestMethod]
        public void Part2_Passes()
        {
            var result = this.solver.SolvePart2(this.realInput);
...
cntj (57)";
        ...
        private string realInput = @"bxlur (38)
vgeifn (90)
