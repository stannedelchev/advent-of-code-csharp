...
namespace AdventOfCode2017.Tests
{
    ...
    public class Day9SolverTests
    {
        ...
        {
            var result = this.solver.SolvePart1("{}");
        ...
        [TestMethod]
        public void Part1Example5_Passes()
        {
            var result = this.solver.SolvePart1("{<a>,<a>,<a>,<a>}");
            Assert.AreEqual(1, result);
        }

        [TestMethod]
        public void Part1Example6_Passes()
        {
            var result = this.solver.SolvePart1("{{<ab>},{<ab>},{<ab>},{<ab>}}");
            Assert.AreEqual(9, result);
        }

        [TestMethod]
        public void Part1Example7_Passes()
        {
            var result = this.solver.SolvePart1("{{<!!>},{<!!>},{<!!>},{<!!>}}");
            Assert.AreEqual(9, result);
        }
        ...
        [TestMethod]
        public void Part1Example8_Passes()
        {
            var result = this.solver.SolvePart1("{{<a!>},{<a!>},{<a!>},{<ab>}}");
        ...
        public void Part1_Passes()
        {
            ...
            Assert.AreEqual(14421, result);
        }

        [TestMethod]
        public void Part2Example1_Passes()
        {
            var result = this.solver.SolvePart2("{<>}");
        ...
        {
            var result = this.solver.SolvePart2("{<random characters>}");
        ...
        [TestMethod]
        public void Part2Example6_Passes()
        {
            var result = this.solver.SolvePart2("{<!!!>>}");
            Assert.AreEqual(0, result);
        }
        ...
        [TestMethod]
        public void Part2Example7_Passes()
        {
            var result = this.solver.SolvePart2(@"{<{o""i!a,<{i<a>}");
